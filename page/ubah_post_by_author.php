    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">Perbaharui postingan anda</div>
                <div class="panel-body">
                    <form action="ubah_post_finish.php" method="post" class="form-horizontal">
                        <input type="hidden" name="id_post" value="<? echo $id ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <textarea class="form-control" name="isi"  rows="10" title="Masukan isi postingan"><? echo $isi ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-4">
                                <input type="submit" value="Perbaharui" name="Ubah" class="btn btn-success"/>
                            </div>
                        </div>
                    </form>
                </div>
